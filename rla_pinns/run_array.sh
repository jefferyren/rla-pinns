...
case $SLURM_ARRAY_TASK_ID in
  ...
  5) ARGS="--wandb --wandb_name=ss_spring_N20 --optimizer=SameSampledSPRING --SameSampledSPRING_lr=0.0924 --SameSampledSPRING_damping=0.0301 --SameSampledSPRING_momentum=0 --SameSampledSPRING_lb_window=30 --SameSampledSPRING_probe_lr=0.0924 --SameSampledSPRING_probe_damping=0.0301 --SameSampledSPRING_beta_max=1 --N_Omega=20 --N_dOmega=10 --batch_frequency=1 --boundary_condition=u_weinan_norm --dim_Omega=100 --equation=poisson --model=mlp-tanh-768-768-512-512 --num_seconds=7000" ;;
  6) ARGS="--wandb --wandb_name=ss_spring_N50 --optimizer=SameSampledSPRING --SameSampledSPRING_lr=0.0924 --SameSampledSPRING_damping=0.0301 --SameSampledSPRING_momentum=0 --SameSampledSPRING_lb_window=30 --SameSampledSPRING_probe_lr=0.0924 --SameSampledSPRING_probe_damping=0.0301 --SameSampledSPRING_beta_max=1 --N_Omega=50 --N_dOmega=25 --batch_frequency=1 --boundary_condition=u_weinan_norm --dim_Omega=100 --equation=poisson --model=mlp-tanh-768-768-512-512 --num_seconds=7000" ;;
  7) ARGS="--wandb --wandb_name=ss_spring_N100 --optimizer=SameSampledSPRING --SameSampledSPRING_lr=0.0924 --SameSampledSPRING_damping=0.0301 --SameSampledSPRING_momentum=0 --SameSampledSPRING_lb_window=30 --SameSampledSPRING_probe_lr=0.0924 --SameSampledSPRING_probe_damping=0.0301 --SameSampledSPRING_beta_max=1 --N_Omega=100 --N_dOmega=50 --batch_frequency=1 --boundary_condition=u_weinan_norm --dim_Omega=100 --equation=poisson --model=mlp-tanh-768-768-512-512 --num_seconds=7000" ;;
  8) ARGS="--wandb --wandb_name=ss_spring_N200 --optimizer=SameSampledSPRING --SameSampledSPRING_lr=0.0924 --SameSampledSPRING_damping=0.0301 --SameSampledSPRING_momentum=0 --SameSampledSPRING_lb_window=30 --SameSampledSPRING_probe_lr=0.0924 --SameSampledSPRING_probe_damping=0.0301 --SameSampledSPRING_beta_max=1 --N_Omega=200 --N_dOmega=100 --batch_frequency=1 --boundary_condition=u_weinan_norm --dim_Omega=100 --equation=poisson --model=mlp-tanh-768-768-512-512 --num_seconds=7000" ;;
